...
alias gkl="gkm && gfo && git_alias_wrap 'git rebase origin/main'"
alias gkm="git_alias_wrap 'git checkout main'"
alias gky="git_alias_wrap 'git checkout -- ../../yarn.lock' || git_alias_wrap 'git checkout -- yarn.lock'"
alias gl="git_alias_wrap 'git log --pretty=oneline'"
alias gr="git_alias_wrap 'git remote -v' && git_alias_wrap 'git branch --all --verbose'"
alias gss="git_alias_wrap_q 'git stash save'"
